...
class FormatterDispatchBatchTests(unittest.TestCase):
    ...
    def test_format_report_accepts_dispatch_batch(self):
        ...
        self.assertEqual(report["input_mode"], "analyst")
        self.assertEqual(report["source_pipeline"], "research_analyst")
        self.assertTrue(report["agent_inclusive"])
        self.assertEqual(report["summary"]["input_mode"], "analyst")
        self.assertEqual(report["batch_key"], "2026-04-01:us:rates")
        self.assertEqual(report["analysis_version"], "2026-04-01")
        self.assertEqual(report["summary"]["batch_key"], "2026-04-01:us:rates")
        self.assertEqual(report["report_metadata"]["batch_key"], "2026-04-01:us:rates")
