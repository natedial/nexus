    ...
    "themes": [
      {
        ...
        "excerpts": [
          {"text": "verbatim quote from paragraph A (max 40 words)"},
          {"text": "verbatim quote from paragraph B (max 40 words)"}
        ],
        ...
        "context": "1 sentence describing explicit relationships stated by the author, or null"
      }
    ],
