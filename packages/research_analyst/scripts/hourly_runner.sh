...
# RESEARCH_ANALYST_* is canonical; the unprefixed names are a deprecated fallback.
POLL_INTERVAL_SECONDS="${RESEARCH_ANALYST_POLL_INTERVAL_SECONDS:-${POLL_INTERVAL_SECONDS:-3600}}"
RUN_BATCH_LIMIT="${RESEARCH_ANALYST_RUN_BATCH_LIMIT:-${RUN_BATCH_LIMIT:-25}}"
MAX_BATCHES_PER_TICK="${RESEARCH_ANALYST_MAX_BATCHES_PER_TICK:-${MAX_BATCHES_PER_TICK:-8}}"
FORECAST_UPLOAD_LIMIT="${RESEARCH_ANALYST_FORECAST_UPLOAD_LIMIT:-${FORECAST_UPLOAD_LIMIT:-250}}"
